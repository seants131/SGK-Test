               ...
               <div class="row">
                        ...
                        <div class="newrealease-contens">
                           <ul id="newrealease-slider" class="list-inline p-0 m-0 d-flex align-items-center">
                              ...
                              @else
                                 ...
                                 <li class="item"><a href="javascript:void(0);"><img src="{{ asset('images/new_realeases/img01.jpg') }}" class="img-fluid w-100 rounded" alt=""></a></li>
                                 <li class="item"><a href="javascript:void(0);"><img src="{{ asset('images/new_realeases/07.jpg') }}" class="img-fluid w-100 rounded" alt=""></a></li>
                                 <li class="item"><a href="javascript:void(0);"><img src="{{ asset('images/new_realeases/img05.jpg') }}" class="img-fluid w-100 rounded" alt=""></a></li>
                              @endif
                           </ul>
                        </div>
                     </div>
                                       ...
                                       <div class="iq-card-body p-0">
                                          <div class="d-flex align-items-center">
                                             <div class="col-6 p-0 position-relative image-overlap-shadow">
                                                ...
                                                <div class="view-book">
                                                    <a href="{{ route('user.books.detail', $book->slug) }}" class="btn btn-sm btn-white">Xem</a>
                                                </div>
                                             </div>
                                             <div class="col-6">
                                                <div class="mb-2">
                  ...
                  <div class="col-lg-6">
                     <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        ...
                        @else
                        <div class="iq-card-body"><p>Không có sách bán chạy nào để hiển thị.</p></div>
                        @endif
                     </div>
                  </div>
                  <div class="col-lg-6">
                              ...
                              @if(isset($categoriesWithBookCounts) && $categoriesWithBookCounts->count() > 0)
                                 ...
                                 <li class="col-sm-6 d-flex mb-3 align-items-center">
                                    <div class="icon iq-icon-box mr-3">
                                       ...
                                       <a href="{{ route('user.categories.detail', $category->id) }}"><img class="img-fluid avatar-60 rounded-circle" src="{{ asset('images/user/category_default.png') }}" alt="{{ $category->name }}"></a>
                                    </div>
                                    <div class="mt-1">
                                       <h6>{{ $category->name }}</h6>
                                       <p class="mb-0 text-primary">Số sách: <span class="text-body">{{ $category->books_count }}</span></p>
                                    </div>
                                 </li>
                                 @endforeach
                              @else
                              ...
                              @if(isset($favoriteBooks) && $favoriteBooks->count() > 0)
                                 ...
                                 <li class="col-md-4">
                                    <div class="d-flex align-items-center">
                                       ...
                                       <div class="col-7">
                                          <h5 class="mb-2" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="{{ $favBook->TenSach }}">{{ Str::limit($favBook->TenSach, 25) }}</h5>
                                          <p class="mb-2">Tác giả : {{ $favBook->TacGia ?: 'N/A' }}</p>                                          
                                          ...
                                          <div class="iq-progress-bar-linear d-inline-block w-100">
                                             @php
                                                 $percentage = ($favBook->LuotMua ?: 0) > 0 ? min(100, (($favBook->LuotMua ?: 0) / 1000) * 100) : 5; // Example: max 1000 sales for 100%
                                                 $bgColor = 'bg-primary';
                                                 if ($percentage > 75) $bgColor = 'bg-success';
                                                 elseif ($percentage > 50) $bgColor = 'bg-info';
                                                 elseif ($percentage > 25) $bgColor = 'bg-warning';
                                             @endphp
                                             <div class="iq-progress-bar {{ $bgColor }}">
                                                <span class="{{ $bgColor }}" data-percent="{{ round($percentage) }}"></span>
                                             </div>
                                          </div>
                                          <a href="{{ route('user.book.pdf') }}" class="text-dark">Đọc ngay<i class="ri-arrow-right-s-line"></i></a> {{-- Consider linking to specific PDF if available: route('user.book.pdf', $favBook->slug) --}}
                                       </div>
                                    </div>
                                 </li>
                                 @endforeach
